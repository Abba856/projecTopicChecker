        ...
        <div class="dashboard-content">
            ...
            <div class="edit-topic-form">
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        <label for="topic_text">Topic Suggestion</label>
                        <textarea id="topic_text" name="topic_text" class="form-control" placeholder="Enter detailed topic suggestion" required><?php echo htmlspecialchars($topic['comment']); ?></textarea>
                    </div>
