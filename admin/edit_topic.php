...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($topic_title) || empty($topic_text) || empty($project_abstract)) {
        ...
        // Update topic
        $stmt = $link->prepare("UPDATE topics SET topic_title = ?, topic_text = ?, project_abstract = ?, status = ? WHERE id = ?");
        $stmt->bind_param("ssssi", $topic_title, $topic_text, $project_abstract, $status, $topic_id);
    ...
    // Update topic data for form display
    $topic['topic_title'] = $topic_title;
    $topic['topic_text'] = $topic_text;
    $topic['project_abstract'] = $project_abstract;
    $topic['status'] = $status;
}
?>
        ...
        <div class="main-content">
            ...
            <div class="dashboard-content">
                ...
                <div class="breadcrumb">
                    ...
                    <i class="fas fa-chevron-right"></i>
                    <a href="view_topic.php?id=<?php echo $topic_id; ?>">View Topic</a>
                    <i class="fas fa-chevron-right"></i>
                ...
                <div class="edit-topic-form">
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="topic_text" name="topic_text" class="form-control" placeholder="Enter topic text/description" required><?php echo htmlspecialchars($topic['topic_text']); ?></textarea>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="view_topic.php?id=<?php echo $topic_id; ?>" class="btn btn-secondary">
