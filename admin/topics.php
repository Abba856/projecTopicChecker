        ...
        <div class="main-content">
            ...
            <div class="dashboard-content">
                <div class="page-header">
                    <h1><i class="fas fa-book"></i> Project Topics</h1>
                    <div class="filter-controls">
                        <button class="btn btn-primary" onclick="window.location.href='add_topic.php'">
                    ...
                    <form method="GET" action="">
                        <div class="filter-row">
                            ...
                            <div class="filter-group">
                                ...
                                <input type="text" name="search" id="search" placeholder="Search by topic title..." value="<?php echo htmlspecialchars($searchTerm); ?>">
                            </div>
                        </div>
                ...
                <div class="table-container">
                            ...
                            <tbody>
                                <?php while ($topic = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div style="font-weight: 600;"><?php echo htmlspecialchars($topic['topic_title']); ?></div>
                                            <div style="font-size: 13px; color: #7f8c8d; margin-top: 5px;">
                                                <?php echo strlen($topic['project_abstract']) > 100 ? substr(htmlspecialchars($topic['project_abstract']), 0, 100) . '...' : htmlspecialchars($topic['project_abstract']); ?>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <?php if ($topic['status'] == 'available'): ?>
                                                    <a href="?action=accept&id=<?php echo $topic['id']; ?>" class="action-btn btn-accept" onclick="return confirm('Are you sure you want to accept this topic?')">
                                                        <i class="fas fa-check"></i> Accept
                                                    </a>
                                                    <a href="?action=reject&id=<?php echo $topic['id']; ?>" class="action-btn btn-reject" onclick="return confirm('Are you sure you want to reject this topic?')">
                                                        <i class="fas fa-times"></i> Reject
                                                    </a>
                                                <?php elseif ($topic['status'] == 'taken'): ?>
                                                    <a href="?action=reset&id=<?php echo $topic['id']; ?>" class="action-btn btn-reset" onclick="return confirm('Are you sure you want to reset this topic to pending?')">
                                                ...
                                                <a href="view_topic.php?id=<?php echo $topic['id']; ?>" class="action-btn btn-view">
                    ...
                    <?php else: ?>
                        <div style="padding: 50px; text-align: center; color: #7f8c8d;">
                            <i class="fas fa-book fa-3x" style="margin-bottom: 20px; color: #bdc3c7;"></i>
