    ...
    <main class="main-content">
        ...
        <header class="admin-header">
            <div class="header-title">
                <h1>View User</h1>
                <p>Review user account details</p>
            </div>
            ...
            <div class="user-details-card">
                ...
                <div class="user-meta">
                    <div class="meta-item">
                        ...
                        <div class="meta-value"><?php echo htmlspecialchars($user['r_fnm']); ?></div>
                    </div>
                    ...
                    <div class="meta-item">
                        ...
                        <div class="meta-value"><?php echo htmlspecialchars($user['r_email']); ?></div>
                    </div>
                    
                    <div class="meta-item">
                        <div class="meta-label">Registration Date</div>
                        <div class="meta-value"><?php echo date('F j, Y', $user['r_time']); ?></div>
                    </div>
                </div>
                
                <div class="actions">
                    <?php if ($user['r_unm'] !== $_SESSION['admin']['unm']): ?>
                        <a href="?id=<?php echo $user['r_id']; ?>&action=delete" class="action-btn btn-delete" onclick="return confirm('Are you sure you want to delete this user? This action cannot be undone.')">
