...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($topic_title) && !empty($project_abstract) && !empty($topic_text)) {
        ...
        $stmt = $link->prepare("INSERT INTO topics (topic_title, project_abstract, topic_text, status, created_at) VALUES (?, ?, ?, 'available', NOW())");
        $stmt->bind_param("sss", $topic_title, $project_abstract, $topic_text);
    ...
    <main class="main-content">
        ...
        <header class="admin-header">
            <div class="header-title">
                <h1>Add Topic</h1>
                <p>Create a new project topic</p>
            </div>
        ...
        <div class="dashboard-content">
            ...
            <div class="add-topic-form">
                <div class="form-header">
                    <h2>New Project Topic</h2>
                    <p>Fill in the details for the new project topic</p>
                </div>
                
                <form method="POST" action="">
                    <div class="form-group">
                        <label for="topic_title">Topic Title</label>
                        <input type="text" id="topic_title" name="topic_title" class="form-control" placeholder="Enter topic title" required>
                    </div>
                    ...
                    <div class="actions">
                        ...
                        <a href="topics.php" class="action-btn btn-secondary">
